...
.opp{font-family:'IBM Plex Sans Arabic','IBM Plex Sans',sans-serif;direction:rtl;background:#f5f2ee}
body.lang-en .opp{direction:ltr}
.opp-hero,.odp-hero,.odps-hero{background:#0d1f3c;padding:80px 60px 64px;position:relative;overflow:hidden}
.opp-hero::before,.odp-hero::before,.odps-hero::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,transparent,#D21217,transparent)}
.opp-hero-inner,.odp-hero-inner,.odps-hero-inner{position:relative;z-index:1;max-width:860px}
.opp-tag,.odp-tag{font-size:11px;letter-spacing:5px;color:#D21217;text-transform:uppercase;font-weight:700;margin-bottom:14px;display:flex;align-items:center;gap:10px}
.opp-tag::before,.odp-tag::before{content:'';width:28px;height:1px;background:#D21217}
...
.opp-h1 i,.odp-h1 i{font-style:italic;color:#D21217}
...
.opp-card{background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 4px 20px rgba(13,31,60,.06);transition:all .3s;direction:rtl}
body.lang-en .opp-card{direction:ltr}
.opp-card:hover{box-shadow:0 10px 36px rgba(13,31,60,.13);transform:translateY(-4px)}
.opp-card-img{height:190px;overflow:hidden;background:#f9f7f5;position:relative}
...
.opp-card-cat{font-size:10px;letter-spacing:2px;color:rgba(210,18,23,.8);text-transform:uppercase;font-weight:700;margin-bottom:6px}
.opp-card-h{font-size:14px;font-weight:700;color:#0d1f3c;line-height:1.4;margin-bottom:8px}
.opp-card-d{font-size:12px;color:rgba(13,31,60,.55);line-height:1.6;font-weight:300;margin-bottom:14px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
/* Archive page */
.odps{font-family:'IBM Plex Sans Arabic','IBM Plex Sans',sans-serif;direction:rtl;background:#f5f2ee}
...
.odps-card{background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 4px 20px rgba(13,31,60,.06);transition:all .3s;direction:rtl}
body.lang-en .odps-card{direction:ltr}
.odps-card:hover{box-shadow:0 10px 36px rgba(13,31,60,.12);transform:translateY(-4px)}
.odps-card-img{height:220px;overflow:hidden;background:#f9f7f5;position:relative}
...
.odps-card-sub{font-size:10px;letter-spacing:2px;color:rgba(210,18,23,.8);text-transform:uppercase;font-weight:700;margin-bottom:6px}
.odps-card-h{font-size:15px;font-weight:700;color:#0d1f3c;line-height:1.35;margin-bottom:8px}
.odps-card-d{font-size:13px;color:rgba(13,31,60,.55);line-height:1.6;font-weight:300;margin-bottom:16px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
.odps-qf{background:#0d1f3c;border-radius:12px;padding:52px 56px;margin-top:24px}
...
.odps-qf-h i{font-style:italic;color:#D21217}
...
.odps-qf-field input:focus,.odps-qf-field select:focus{border-color:rgba(210,18,23,.5)}
.odps-qf-field select option{background:#0d1f3c;color:#fff}
.odps-qf-submit{display:inline-flex;align-items:center;justify-content:center;gap:8px;background:#D21217;color:#fff;font-family:'IBM Plex Sans Arabic','IBM Plex Sans',sans-serif;font-size:13px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;padding:0 28px;height:48px;border:none;border-radius:6px;cursor:pointer;transition:background .2s;white-space:nowrap;min-height:44px}
.odps-qf-submit:hover{background:#e8464b}
/* Detail page */
.opdtl{font-family:'IBM Plex Sans Arabic','IBM Plex Sans',sans-serif;direction:rtl;background:#f5f2ee}
body.lang-en .opdtl{direction:ltr}
.opdtl-hero{background:#0d1f3c;padding:72px 60px 56px;position:relative;overflow:hidden}
.opdtl-hero::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,transparent,#D21217,transparent)}
...
.opdtl-breadcrumb a:hover{color:#D21217}
...
.opdtl-cat-tag{font-size:10px;letter-spacing:3px;color:#D21217;text-transform:uppercase;font-weight:700;margin-bottom:12px}
...
.opdtl-img-wrap{background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 12px 48px rgba(13,31,60,.12);position:sticky;top:120px}
.opdtl-img-wrap img{width:100%;max-height:460px;object-fit:contain;display:block;padding:24px;background:#fff}
.opdtl-certs-row{display:flex;flex-wrap:wrap;gap:8px;padding:16px 20px;border-top:1px solid rgba(13,31,60,.06)}
.opdtl-cert{display:inline-flex;align-items:center;gap:5px;background:rgba(210,18,23,.05);border:1px solid rgba(210,18,23,.18);color:#D21217;font-size:10px;font-weight:700;letter-spacing:1px;padding:4px 11px;border-radius:20px}
...
.opdtl-desc{font-size:15px;color:rgba(13,31,60,.68);line-height:1.75;font-weight:300;margin-bottom:32px}
.opdtl-specs-wrap h3{font-size:12px;letter-spacing:2px;color:rgba(13,31,60,.4);text-transform:uppercase;font-weight:700;margin-bottom:14px}
.opdtl-specs-table{width:100%;border-collapse:collapse;border-radius:8px;overflow:hidden;box-shadow:0 2px 12px rgba(13,31,60,.06)}
.opdtl-specs-table td{padding:11px 16px;font-size:13px;border-bottom:1px solid rgba(13,31,60,.06)}
.opdtl-specs-table td:first-child{font-weight:600;color:#0d1f3c;background:#fff;width:44%}
.opdtl-specs-table td:last-child{color:rgba(13,31,60,.7);background:#fafaf8}
.opdtl-specs-table tr:last-child td{border-bottom:none}
.opdtl-cta{background:#0d1f3c;border-radius:12px;padding:40px 36px;margin-top:32px;position:relative;overflow:hidden}
.opdtl-cta::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,#D21217,transparent)}
...
.opdtl-cta h3 i{font-style:italic;color:#D21217}
...
.opdtl-cta-p{display:inline-flex;align-items:center;justify-content:center;gap:7px;background:#D21217;color:#fff;font-family:'IBM Plex Sans Arabic','IBM Plex Sans',sans-serif;font-size:12px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;padding:12px 22px;border:none;border-radius:3px;cursor:pointer;transition:background .2s;min-height:42px}
.opdtl-cta-p:hover{background:#e8464b}
...
.opdtl-related h2{font-family:'IBM Plex Sans','IBM Plex Sans Arabic',sans-serif;font-size:22px;font-weight:700;color:#0d1f3c;margin-bottom:20px}
.opdtl-related h2 i{font-style:italic;color:#D21217}
.opdtl-related-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px}
.opdtl-rel-card{background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 3px 14px rgba(13,31,60,.06);transition:all .3s;text-decoration:none;display:block}
.opdtl-rel-card:hover{box-shadow:0 8px 28px rgba(13,31,60,.12);transform:translateY(-3px)}
.opdtl-rel-card-img{height:140px;overflow:hidden;background:#f9f7f5}
...
.opdtl-rel-card-name{font-size:12px;font-weight:700;color:#0d1f3c;line-height:1.35;margin-bottom:6px}
.opdtl-rel-quote{width:100%;background:#D21217;color:#fff;border:none;border-radius:4px;padding:7px 10px;font-family:'IBM Plex Sans Arabic','IBM Plex Sans',sans-serif;font-size:11px;font-weight:700;cursor:pointer;transition:background .2s;min-height:32px}
.opdtl-rel-quote:hover{background:#e8464b}
...
<div style="margin-bottom:56px">
	<div style="border-bottom:2px solid rgba(13,31,60,.08);padding-bottom:16px;margin-bottom:28px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
		<h2 style="font-family:'IBM Plex Sans','IBM Plex Sans Arabic',sans-serif;font-size:24px;font-weight:700;color:#0d1f3c;line-height:1.2"><?php osoul_bilingual( $gl['ar'], $gl['en'] ); ?></h2>
		<span style="font-size:12px;color:rgba(13,31,60,.4);letter-spacing:1px"><?php echo count( $gitems ); ?> <?php osoul_bilingual( 'منتج', 'products' ); ?></span>
	</div>
	<div class="opp-grid">
...
<div class="odps-hero"><div class="odps-hero-inner">
	<div style="font-size:11px;letter-spacing:5px;color:#D21217;text-transform:uppercase;font-weight:700;margin-bottom:14px;display:flex;align-items:center;gap:10px;position:relative"><span style="width:28px;height:1px;background:#D21217;display:block"></span><?php osoul_bilingual( $pd['tag'], $pd['tag_en'] ); ?></div>
	<h1 style="font-family:'IBM Plex Sans','IBM Plex Sans Arabic',sans-serif;font-size:clamp(28px,4.5vw,50px);font-weight:700;color:#fff;line-height:1.2;margin-bottom:12px;position:relative"><span data-lang="ar"><i style="font-style:italic;color:#D21217"><?php echo esc_html( $pd['h'] ); ?></i></span><span data-lang="en"><i style="font-style:italic;color:#D21217"><?php echo esc_html( $pd['h_en'] ); ?></i></span></h1>
