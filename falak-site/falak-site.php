 ...
 * Text Domain:       falak
 *
 * بنية معيارية (modules) مستوحاة من إضافة osoul-site، لكن مبسّطة ومخصّصة لمدرسة تحفيظ قرآن:
 * الواجهة عربية فقط (RTL)، بألوان أخضر/أبيض/ذهبي، مع نظام تسجيل بديل عن نظام عروض الأسعار.
 */
...
$falak_modules = array(
	...
	'inc/programs.php',      // البرامج/الحلقات (بيانات افتراضية + CPT قابل للإدارة)
