...
const FIXTURES = [
  ...
  /* ملفُّ إنجازٍ **يرسم نفسه**: متنُه المكتوب قالبٌ فيه {{ p.title }}،
     وجافاسكربتُه يولّد ثمانيًا وخمسين صفحةً عند الفتح. وهو هنا لأنّ
     الطريق الذي يمرّ به وحده يكشف انكسارَه: لو عاد المستورد يقرأ
     المصدر بدل أن يُشغّله لخرجت العلامات حرفيّةً في وجه المالك.

     وحدُّ صفحته ١٤٠px لا ٨ كالأخريَين، وهذا **فجوةٌ معلومةٌ لا رخصة**:
     في صفحاته منطقتان مرنتان (`flex: 1 1 0%`) تقتسمان ما يفضل من
     الورقة. ومجموعُ ما تقتسمانه عندنا كما هو في الأصل — ٧٢٩٫٨ مقابل
     ٧٢٩٫٦ — لكنّ القسمة تختلف: تأخذ الأولى ٤٩٤ وتُبقي للثانية ٢٣٥،
     والأصلُ يقسمها نصفين. فتعلو صناديقُ التعبئة الفارغة ويصغر البياض
     تحتها، والمتن كلُّه في موضعه ولا يفيض شيء.

     وطُوردت في أربعة مسارات — النائبُ الذي يحشوه العارض في العقد
     الفارغة، وارتفاعُ الصناديق، وعناصرُ تحمل صندوقًا فتُستورد علامةً،
     وحدُّ المرونة الأدنى — فلم يُغيّر أيٌّ منها الرقم. وأُزيل كلُّ ما
     جُرِّب: لا تُترك شيفرةٌ لا يُرى أثرُها.

     والحدُّ هنا يحرس ألّا تزيد الفجوة، لا أن تُغتفر. */
  { file: 'admin.design.html', name: 'إنجاز', pages: 58, tolerance: 140, maxLoose: 240 },
]
