...
const DICT = {
  ar: {
    ...
    runCheck: 'فحص الاتصال',
    checkRunning: 'جارٍ الفحص…',
    techDetails: 'تفاصيل تقنية',
    verdictOk: 'كل شيء سليم — الاستقبال والإرسال يعملان.',
    verdictNetworkOk: 'الشبكة سليمة والخادم يرد. اكتب كلمة المرور وأعد الفحص لاختبار الحساب.',
    verdictBadEmail: 'صيغة البريد الإلكتروني غير صحيحة.',
    verdictDomain: 'هذا البريد ليس من نطاق الشركة المعتمد.',
    verdictDns: 'تعذّر ترجمة اسم خادم البريد. المشكلة في إعدادات الشبكة أو DNS على هذا الجهاز.',
    verdictBlocked: 'المنفذ مغلق. غالبًا جدار الحماية أو برنامج الحماية أو شبكة الشركة تحجب بريد IMAP.',
    verdictTls: 'فشل تشفير الاتصال. قد يعترضه برنامج حماية يفحص الاتصالات المشفّرة.',
    verdictCert: 'برنامج الحماية أو جدار الحماية يعترض الاتصال ويضع شهادته الخاصة. الحل: أوقف خيار "فحص SSL/HTTPS" في برنامج الحماية على هذا الجهاز، ثم أعد المحاولة.',
    verdictImapAuth: 'الخادم يرد، لكنه رفض البريد أو كلمة المرور. تأكد من كلمة المرور من لوحة مزوّد البريد.',
    verdictImapFail: 'الخادم يرد، لكن تسجيل الدخول فشل. انظر التفاصيل التقنية.',
    ...
    pwStep1Hint: 'تفتح صفحة بريدك داخل التطبيق. ادخل ببريدك، ثم أيقونة الإعدادات أعلى اليمين ← All Settings ← Account settings ← Change password.',
    pwNowUpdateHere: 'غيّرتها؟ اكتب القديمة والجديدة هنا الآن.',
    pwRules: 'شرط المزوّد: ٨ أحرف فأكثر، وفيها حرف كبير وحرف صغير ورقم ورمز، بحروف لاتينية.',
  ...
  en: {
    ...
    runCheck: 'Test the connection',
    checkRunning: 'Testing…',
    techDetails: 'Technical details',
    verdictOk: 'All good — receiving and sending both work.',
    verdictNetworkOk: 'The network is fine and the server answers. Enter the password and test again to check the account.',
    verdictBadEmail: 'That email address is not valid.',
    verdictDomain: 'This mailbox is outside the approved company domain.',
    verdictDns: 'The mail server name could not be resolved. The problem is DNS or the network settings on this computer.',
    verdictBlocked: 'The port is closed. Usually a firewall, antivirus, or company network blocking IMAP mail.',
    verdictTls: 'The secure connection failed. Security software inspecting encrypted traffic can cause this.',
    verdictCert: 'Security software or a firewall is intercepting the connection with its own certificate. Fix: turn off “SSL/HTTPS scanning” in the antivirus on this computer, then try again.',
    verdictImapAuth: 'The server answers but refused the email or password. Confirm the password in your mail provider’s panel.',
    verdictImapFail: 'The server answers but sign-in failed. See the technical details.',
    ...
    pwStep1Hint: 'Opens your mail site inside the app. Sign in, then the settings icon at the top right → All Settings → Account settings → Change password.',
    pwNowUpdateHere: 'Changed it? Enter the old and new password here now.',
    pwRules: 'The provider requires 8+ characters with an uppercase letter, a lowercase letter, a number and a symbol, in Latin script.',
