...
final class SCH_Apps
{
     ...
     *
     * **واللون هنا هو لون التطبيق على جوّال المستخدم** (شريط النظام وبطاقة
     * المتجر) — فهو نفسه `--p-brand` و`--t-brand` داخل الشاشة. لونان مختلفان
     * يعنيان تطبيقًا يبدو غير الذي فُتح.
     */
    private const PACKS = [
        'family' => [
            'name'  => 'مدرستي — الأسرة',
        ...
        'staff' => [
            ...
            // «ليل» وليس أخضر: الأخضر في هذا التطبيق يعني «حاضر» والأحمر «غائب»،
            // ولو صار هويةً لتوقّف اللون عن قول الحالة.
            'color' => '#1B3A57',
            'icon'  => 'icon-gate',
