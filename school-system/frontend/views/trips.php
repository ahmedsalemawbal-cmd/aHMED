            ...
            <table class="sch-table">
                ...
                <?php foreach ($trips as $t) : ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($t->status === 'running') : ?>
                                <form method="post" action="<?php echo esc_url(SCH_Dashboard::post_url()); ?>" onsubmit="return confirm('<?php esc_attr_e('ستُغلق الرحلة. تأكد أن كل الطلاب نزلوا. متابعة؟', 'school-system'); ?>');">
